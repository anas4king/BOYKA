...
local UserName = (data.username_ or "ssoooz")
...
send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث السورس \n ❃∫ لديك اخر اصدار لسورس سوز\n ❃∫ الاصدار » { 1.3v}')
dofile('BOYKA.lua')  
end
if text == 'الاصدار ❃' and DevBOYKAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ اصدار سورس سوز \n ❃∫ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت ❃' and DevBOYKAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ [تحديثات البوت](t.me/ccscc2) \n ❃∫ [قناه السورس](t.me/ssoooz)')
end
...
usertext = '\n ❃∫ العضو » ['..result.title_..'](t.me/'..(username or 'ssoooz')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ssoooz')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
if BOYKA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ssoooz')..') \n ❃∫ '..BOYKA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/ssoooz)}\n ❃∫ ["..BOYKA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❃∫ عذرا » {["..data.first_name_.."](T.ME/ssoooz)}\n ❃∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
≪━━━━━━𝘀𝗼𝘇━━━━━━≫
 ❃∫ ↬𝐒𝐎𝐙 𝐓𝐄𝐀𝐌 ⁦
≪━━━━━━𝘀𝗼𝘇━━━━━━≫
 ❃∫ ↬[Channel BOYKA](t.me/ssoooz) 
≪━━━━━━𝘀𝗼𝘇━━━━━━≫
 ❃∫ ↬[Information](t.me/ccscc2)
≪━━━━━━𝘀𝗼𝘇━━━━━━≫
 ❃∫ ↬[DEVELOPER](t.me/l3lll3l)
≪━━━━━━𝘀𝗼𝘇━━━━━━≫
 ❃∫ ↬[orders boyka](t.me/ssooooz)
≪━━━━━━𝘀𝗼𝘇━━━━━━≫
 ❃∫ ↬[To talk to us](t.me/t_w_1bot)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ssoooz')..') \n ❃∫ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ssoooz')..') \n ❃∫ تـم قفـل التاك بالكتم ')
end,nil)   
...
if Get_info then
local TextS = "\n ❃∫ اهلا بك في متجر ملفات سوز\n ❃∫ ملفات السورس ↓\n≪━━━━━━𝘀𝗼𝘇━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━𝘀𝗼𝘇━━━━━━≫\n ❃∫ علامة تعني { ✓ } ملف مفعل\n ❃∫ علامة تعني { ✘ } ملف معطل\n ❃∫ قناة سورس سوز ↓\n".." ❃∫ [اضغط هنا لدخول](t.me/ssoooz) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ❃∫ عذرا الملف لايدعم سورس سوز \n") 
end
return false
end
...
local UserName = (b.username_ or "ssoooz")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❃∫ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ssoooz')..')'
status  = '\n ❃∫ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❃∫ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ssoooz')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❃∫ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'ssoooz')..')'..'\n ❃∫ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'سوز').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'سوز')
local BOYKA_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سوز').." غادر" or text == 'غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'ssoooz')..')'
local iduser = result.sender_user_id_
...
send(msg.chat_id_, msg.id_, t..'ٴ❃∫ٴ≪━━━━━━𝘀𝗼𝘇━━━━━━≫ٴ❃∫○ٴ\n❃∫ 彡 .[𝐒𝐎𝐙 𝐂𝐇𝐀𝐍𝐍𝐄𝑳](t.me/ssoooz)➢ ')
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'سوز')
